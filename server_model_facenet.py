...
class FacenetPre():
    def __init__(self):
        ...
        fr = open('../facenet_files/1knowns_db_color_facenet0924_iqjv1.pkl', 'rb')
...
#     facenet_c.gen_knows_db('../facenet_files/dc_marking/', '../facenet_files/1knowns_db_color_facenet0917_v3.pkl')
